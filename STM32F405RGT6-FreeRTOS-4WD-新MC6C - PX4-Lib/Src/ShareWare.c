...
ParseData_Struct ParseData_Mast;//创建一个ringBuff的环形缓冲区结构体参数

QueueHandle_t MastMessage_Queue;	//主机消息队列句柄

US_Struct US1;//超声波结构体参数
US_Struct US2;//超声波结构体参数


CapturePulse_Struct CapturePulse_1;//创建捕获脉宽结构体参数
CapturePulse_Struct CapturePulse_2;//创建捕获脉宽结构体参数
CapturePulse_Struct CapturePulse_3;//创建捕获脉宽结构体参数
CapturePulse_Struct CapturePulse_4;//创建捕获脉宽结构体参数
