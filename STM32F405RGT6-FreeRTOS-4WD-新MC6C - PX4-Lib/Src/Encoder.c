...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
	...
	{
		CapturePulse_1.TIM_IT_OverCount++;//定时器溢出中断计数值
		CapturePulse_2.TIM_IT_OverCount++;//定时器溢出中断计数值
		CapturePulse_3.TIM_IT_OverCount++;//定时器溢出中断计数值
		CapturePulse_4.TIM_IT_OverCount++;//定时器溢出中断计数值
	}
