...
{
	uint8_t Hex[4];// 4 个字节的数组，用于访问 float 的每个字节
	float floatValue;// 4 字节的浮点数
};
...
extern __IO uint8_t SystemState;
...
extern CapturePulse_Struct CapturePulse_1;//创建捕获脉宽结构体参数
extern CapturePulse_Struct CapturePulse_2;//创建捕获脉宽结构体参数
extern CapturePulse_Struct CapturePulse_3;//创建捕获脉宽结构体参数
extern CapturePulse_Struct CapturePulse_4;//创建捕获脉宽结构体参数
